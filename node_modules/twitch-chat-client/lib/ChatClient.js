...
var ChatClient = /** @class */ (function (_super) {
    ...
    function ChatClient(authProvider, options) {
        ...
        var _this = _super.call(this, {
            ...
            logger: tslib_1.__assign({ minLevel: options.logLevel }, ((_e = options.logger) !== null && _e !== void 0 ? _e : {})),
        ...
        if ((authProvider === null || authProvider === void 0 ? void 0 : authProvider.tokenType) === 'app') {
            throw new twitch_auth_1.InvalidTokenTypeError('You can not connect to chat using an AuthProvider that supplies app access tokens.\n' +
        ...
        _this._chatLogger = new logger_1.Logger(tslib_1.__assign({ name: 'twitch-chat', emoji: true, minLevel: options.logLevel }, ((_f = options.logger) !== null && _f !== void 0 ? _f : {})));
        ...
        var executeJoinRequest = function (channel) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _this = this;
        ...
        if (options.botLevel) {
            if (options.isAlwaysMod) {
                _this._messageRateLimiter = new rate_limiter_1.TimeBasedRateLimiter({
                ...
                _this._messageRateLimiter = new rate_limiter_1.TimedPassthruRateLimiter(new rate_limiter_1.PartitionedTimeBasedRateLimiter({
                    bucketSize: 1,
                    timeFrame: 1200,
            ...
            _this._joinRateLimiter = new rate_limiter_1.TimeBasedRateLimiter({
            ...
            _this._whisperRateLimiter = new rate_limiter_1.TimedPassthruRateLimiter(new rate_limiter_1.TimeBasedRateLimiter({
            ...
            _this._messageRateLimiter = new rate_limiter_1.NullRateLimiter(executeChatMessageRequest);
            _this._joinRateLimiter = new rate_limiter_1.NullRateLimiter(executeJoinRequest);
            _this._whisperRateLimiter = new rate_limiter_1.NullRateLimiter(executeWhisperRequest);
        }
    ...
    ChatClient.prototype.host = function (channel, target) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                channelName = UserTools_1.toUserName(channel !== null && channel !== void 0 ? channel : this._credentials.nick);
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var e = _this._onHostResult(function (chan, error) {
                            if (UserTools_1.toUserName(chan) === channelName) {
                                if (error) {
                                    reject(error);
                                }
                                else {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var e = _this._onBanResult(function (_channel, _user, error) {
                            if (UserTools_1.toUserName(_channel) === channelName && UserTools_1.toUserName(_user) === user) {
                                if (error) {
                                    reject(error);
                                }
                                else {
    ...
    ChatClient.prototype.deleteMessage = function (channel, message) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                channel = UserTools_1.toUserName(channel);
                messageId = ChatMessageAttributes_1.extractMessageId(message);
                return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (attributes.replyTo) {
                    tags['reply-parent-msg-id'] = ChatMessageAttributes_1.extractMessageId(attributes.replyTo);
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, this._whisperRateLimiter.request({
                        target: UserTools_1.toUserName(user),
                        message: message
                    })];
            });
        });
    ...
    ChatClient.prototype.join = function (channel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this._joinRateLimiter.request(UserTools_1.toChannelName(channel))];
            });
        });
    };
    /**
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 5:
                        e_1 = _e.sent();
                        if (e_1 instanceof twitch_auth_1.InvalidTokenError) {
                            lastTokenError = e_1;
                        }
                        else {
                    ...
                    case 11:
                        e_2 = _e.sent();
                        if (e_2 instanceof twitch_auth_1.InvalidTokenError) {
                            lastTokenError = e_2;
                        }
                        else {
    ...
    ChatClient = ChatClient_1 = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch-chat-client', 'ChatClient')
    ], ChatClient);
    return ChatClient;
}(ircv3_1.IrcClient));
